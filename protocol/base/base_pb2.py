...
_OPCODE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='PERSONAL', index=84, number=16001,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='REGISTER_SERVICE', index=85, number=1000,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='CHANGE_SERVICE_STATE', index=86, number=1001,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='GAME_UPDATE_CURRENCY', index=87, number=1004,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='CHANGE_ONLINE', index=88, number=1005,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='GAME_SVR_OFFLINE', index=89, number=1008,
            options=None,
            type=None),
    ],
