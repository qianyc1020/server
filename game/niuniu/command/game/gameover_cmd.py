...
def execute(room, messageHandle):
    ...
    if room.gameStatus == GameStatus.PLAYING:
        ...
        niuniuPlayerOneSetResult.positionWin.append(0)
        niuniuPlayerOneSetResult.positionWin.append(0)
        niuniuPlayerOneSetResult.positionWin.append(0)
        niuniuPlayerOneSetResult.positionWin.append(0)
        niuniuPlayerOneSetResult.positionWin.append(0)
        ...
        for u in settleResult.userSettleResule:
            win = u.win
            if u.win > 0:
                niuniuPlayerOneSetResult.positionWin[u.userId] = 1
            elif u.win < 0:
                niuniuPlayerOneSetResult.positionWin[u.userId] = 2
            if win != 0:
        ...
        for k in userScore:
            ...
            if seat is not None:
                ...
                if 0 != userwin:
                    ...
                    data_game_details.create_game_details(k, 10, str(room.roomNo), userwin, userScore[k] - userwin,
                                                          int(time.time()))
                # TODO 经验值和返利

        room.trend.append(niuniuPlayerOneSetResult.positionWin)
        ...
        if 1 != room.banker:
            ...
            if 0 != bankerFinalWin:
                ...
                data_game_details.create_game_details(room.banker, 10, str(room.roomNo), bankerFinalWin,
