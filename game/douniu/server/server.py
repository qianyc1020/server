...
from game.douniu.command.client import match_cmd, reconnection_cmd, exit_cmd, ready_cmd, change_match_cmd, change_online
...
from game.douniu.server.command import chat_cmd, interaction_cmd, action_cmd, gps_cmd, voice_cmd, currency_cmd
